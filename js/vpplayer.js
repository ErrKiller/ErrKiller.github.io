...
(function($) {
	...
	function cP() {
		h.c.pE = h.d("div", {
			...
			(h.playerColor != undefined) ? (
				(h.playerColor.con(",")) ? (
					[{
							a: "background",
							v: "linear-gradient(" + h.playerColor + ")"
						},
						{
							a: "background",
							v: "-webkit-linear-gradient(" + h.playerColor + ")"
						},
						{
							a: "background",
							v: "-moz-linear-gradient(" + h.playerColor + ")"
						}, ((h.vwl == "minimal") ? {
							a: "height",
							v: "70px"
						} : undefined)
		...
		h.c.pc = h.d("div", {
			...
			(h.playerColor != undefined) ? (
				(h.playerColor.con(",")) ? (
					[{
							a: "box-shadow",
							v: "inset -1px 0px 0px " + h.playerColor.split(",")[1]
						},
						{
							a: "-webkit-box-shadow",
							v: "inset -1px 0px 0px " + h.playerColor.split(",")[1]
						...
						a: "box-shadow",
						v: "inset -1px 0px 0px " + h.playerColor
					},
					{
						a: "-webkit-box-shadow",
						v: "inset -1px 0px 0px " + h.playerColor
		...
		h.c.trkcr = h.d("div", {
			a: "class",
			v: "track-container"
		}, undefined, (h.vwl == "basic" || h.vwl == "minimal") ? {
			a: "width",
			v: "100%"
		} : undefined);
		...
		h.c.tnd = h.d("div", {
			...
			(h.displayColor != undefined) ? (
				(h.displayColor.con(",")) ? (
					[{
							a: "box-shadow",
							v: "inset -1px 0px 0px " + h.displayColor.split(",")[1]
						},
						{
							a: "-webkit-box-shadow",
							v: "inset -1px 0px 0px " + h.displayColor.split(",")[1]
						...
						a: "box-shadow",
						v: "inset -1px 0px 0px " + h.displayColor
					},
					{
						a: "-webkit-box-shadow",
						v: "inset -1px 0px 0px " + h.displayColor
		...
		h.c.tcr = h.d("div", {
			...
			(h.displayColor != undefined) ? (
				(h.displayColor.con(",")) ? ([{
						a: "background",
						v: "linear-gradient(" + h.displayColor + ")"
					},
					{
						a: "background",
						v: "-webkit-linear-gradient(" + h.displayColor + ")"
					},
					{
						a: "background",
						v: "-moz-linear-gradient(" + h.displayColor + ")"
					}
				]) : ({
					a: "background",
					v: h.displayColor
